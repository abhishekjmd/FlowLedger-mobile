        ...
        <View style={styles.section}>
          ...
          {!isCategoriesLoading && categories.length === 0 && (
            <View style={{ marginBottom: 10 }}>
              <Text style={styles.errorText}>
                {categoriesError
                  ? "Could not load categories. Please retry."
              ...
              >
                <Text style={styles.retryBtnText}>
                  {isCategoriesFetching ? "Retrying..." : "Retry"}
                </Text>
              </TouchableOpacity>
            </View>
          )}
                ...
                <View style={styles.groupRow}>
                  ...
                  >
                    <Text
                      style={[
                        ...
                        !value && styles.groupChipTextActive,
                      ]}
                    >
                      Personal
                    </Text>
                  ...
                  {groups.map((g: any) => (
                    <TouchableOpacity
                      ...
                      style={[
                        styles.groupChip,
                        value === g.id && styles.groupChipActive,
                      ]}
                    ...
                    >
                      <Text
                        style={[
                          styles.groupChipText,
                          value === g.id && styles.groupChipTextActive,
                        ]}
                      >
                        {g.name}
                      </Text>
